...
module.exports = function (app, io) {
	...
	var chat = io.on('connection', function (socket) {
		...
		//When the client emits the 'load' event, reply 
		//with the number of people in this chat room
		...
		socket.on('login', function(data) {
			...
			if(room.length < 2) {
				...
				if(room.length === 1) {
					...
					//room, along with list off people that are in it.
		...
		socket.on('disconnect', function() {
			...
			//Notify the person in chat room that his partner
			//has left
